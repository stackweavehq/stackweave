...
With `strict_mode: true`, `null` and `undefined` are not assignable to other types.
...
All code should be compatible with `ES2022`. Avoid stage-3 proposals or platform APIs
